...
TEXTE = [
    ...
    ('Ein geschützter Raum, in dem du dich verstanden, gesehen und getragen fühlst — und in dem du genau die Person sein darfst, die du bist.',
     ...
     'Um espaço protegido, com compreensão, escuta e amparo — e onde podes ser exatamente quem és.'),
    ...
    ('Wie das aussieht, wenn wir zusammenarbeiten, steht hier.',
     'What working together actually looks like is below.',
     'Como é trabalharmos juntos, explico aqui em baixo.'),
    ...
    ('Im Gespräch schauen wir gemeinsam auf das, was gerade wirklich in dir vorgeht. Nicht auf das, was du anderen erzählst, wenn sie fragen, wie es dir geht — sondern auf das, was darunter liegt.',
     'In our conversation we look together at what’s really going on inside you. Not at what you tell other people when they ask how you are — but at what sits underneath.',
     'Na conversa olhamos juntos para o que se passa de facto dentro de ti. Não para aquilo que dizes aos outros quando perguntam como estás — mas para o que está por baixo.'),
    ('Du gewinnst Klarheit über deine Situation, über die Muster, die sich wiederholen, und über deine nächsten Schritte — privat wie beruflich. Ich halte einen geschützten Raum, in dem du ehrlich sein darfst, auch dir selbst gegenüber. Ich dränge dich zu nichts; das Tempo bestimmst du.',
     'You gain clarity about your situation, about the patterns that keep repeating, and about your next steps — in your private life and at work. I hold a sheltered space where honesty is possible, including with yourself. I won’t push you anywhere; you set the pace.',
     'Ganhas clareza sobre a tua situação, sobre os padrões que se repetem e sobre os próximos passos — na vida pessoal e na profissional. Crio um espaço protegido onde há lugar para a verdade, também contigo. Não te empurro para nada; o ritmo é teu.'),
    ...
    ('Nicht jeder Mensch ist über Worte erreichbar. Für alle, bei denen der Weg über den Körper führt, arbeite ich zusätzlich mit',
     'Not everyone can be reached through words. For those whose route runs through the body, I also work with',
    ...
    ('Wir sehen uns in meinen Räumen in Düsseldorf, wo du in Ruhe ankommen kannst — oder online, wenn dir das lieber ist oder der Weg zu weit wäre. Was du mir erzählst, bleibt zwischen uns. Und zwischen den Terminen bin ich erreichbar, falls etwas hochkommt, das nicht bis zum nächsten Mal warten kann.',
     ...
     'Encontramo-nos no meu espaço em Düsseldorf, onde podes chegar com calma — ou online, se preferires ou se a distância for muita. O que me contas fica entre nós. E entre as sessões estou disponível, caso surja algo que não possa esperar pela próxima.'),
    ...
    ('Welches Paket zu dir passt, entscheiden wir nach dem Erstgespräch gemeinsam. Damit du vorher weißt, worauf du dich einlässt, steht hier alles offen.',
     'We decide together which package suits you, once we have had that first conversation. So you know what you’re getting into, it’s all set out here.',
    ...
    ('Als zertifizierter Life &amp; Business Coach verbinde ich fundiertes Wissen mit einem feinen Gespür für das, was zwischen den Zeilen liegt. In meiner Arbeit werde ich oft als „Emotionsöffnerin" beschrieben — als jemand, der in einem geschützten Raum echte Gefühle sichtbar macht, Klarheit schafft und liebevoll Halt gibt.',
     'As a certified life &amp; business coach I bring together solid training and a fine ear for what sits between the lines. People often describe me as someone who opens up emotions — someone who makes real feelings visible in a sheltered space, creates clarity and offers warm, steady support.',
     'Como Life &amp; Business Coach certificada, junto formação sólida a um ouvido fino para o que fica nas entrelinhas. Descrevem-me muitas vezes como alguém que abre as emoções — alguém que, num espaço protegido, torna visíveis os sentimentos verdadeiros, cria clareza e dá um apoio firme e carinhoso.'),
    ('Ich arbeite mit Menschen, die mehr wollen — mehr Sinn, mehr inneres Gleichgewicht, mehr Selbstverbindung. Ob es um private Themen oder berufliche Entwicklung geht: Mein Coaching ist ein Raum, in dem du dich verstanden, gesehen und getragen fühlst.',
     ...
     'Trabalho com pessoas que querem mais — mais sentido, mais equilíbrio interior, mais ligação consigo mesmas. Seja um tema pessoal ou o desenvolvimento profissional: o meu coaching é um espaço com compreensão, escuta e amparo.'),
    ...
    ('Meine Jahre in der Wirtschaft und der Aufbau mehrerer Unternehmen mit Fokus Immobilien — dieser Teil meines Weges ist nicht verschwunden. Für alle, die diese Seite ihres Lebens endlich selbst in die Hand nehmen möchten, biete ich ein eigenes Format an. Ich verkaufe nichts und empfehle keine Produkte. Ich sorge dafür, dass du verstehst, was du tust, und dass du dranbleibst.',
     'My years in business and building several real-estate companies — that part of my path hasn’t gone anywhere. For anyone who finally wants to take this side of their life into their own hands, I offer a format of its own. I sell nothing and recommend no products. What I do is make sure you understand what you’re doing, and that you stick with it.',
    ...
    ('Für alle, bei denen Geld ein diffuses Unbehagen ist. Wir schauen gemeinsam hin: Was kommt rein, was geht raus, was bleibt. Wir bauen einen Puffer auf, der dir nachts Ruhe gibt, und räumen auf, was sich angesammelt hat. Am Ende kennst du deine Zahlen — und das allein verändert erstaunlich viel.',
     'For anyone to whom money is a vague unease. We look at it together: what comes in, what goes out, what stays. We build a cushion that lets you sleep at night, and clear up what has piled up. At the end you know your numbers — and that alone changes a surprising amount.',
...
SEITEN = {
    'index': {
        ...
        'en': ('Andreia da Costa — Live authentically, act with clarity',
               'Life &amp; business coaching, hnc and retreats in Düsseldorf. A space where you are seen.'),
